...
class GenerationMixin:
    ...
    def generate(
        ...
        gedi_decoder: Optional = None,
        gedi_params: Optional = None,
        **model_kwargs,
        ...
        if is_greedy_gen_mode:
            ...
            return self.greedy_search(
                ...
                tokenizer=tokenizer,
                gedi_decoder=gedi_decoder,
                gedi_params=gedi_params,
                **model_kwargs,
            )
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        step_idx = 0        
        # parameters for GeDi decoding
        if gedi_params is not None:
            assert gedi_decoder is not None
            ignore_first_t = gedi_params["ignore_first_t"] 
            top_beam = gedi_params["top_beam"] 
            gedi_lambda = gedi_params["gedi_lambda"] 
            verbose = gedi_params["verbose"]
            assert 0. <= gedi_lambda <= 1.
        ...
        while True:
            ...
            next_token_logits_with_gedi = outputs.logits[:, -1, :]
