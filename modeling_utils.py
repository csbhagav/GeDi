    ...
    def _generate_no_beam_search(
        ...
        while cur_len < max_length:
            ...
            if not(gedi_model is None):
                ...
                # CAUTION: The following deletion might affect the decoder behavior
                # pad_lens and past are not expected in the forward function in GPT2 (latest HF codebase)
                # As far as I used for script/run_generation.sh, the output still looks reasonable with 
                # this modification.
                del inputs["pad_lens"]
                if "past" in inputs.keys():
                    del inputs["past"]
